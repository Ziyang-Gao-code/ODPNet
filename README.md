...
This repository contains the official PyTorch implementation of **ODPNet: Orthogonal Dual-Path Network for Real-Time Semantic Segmentation of Urban Road Scenes**, published in **IEEE Transactions on Vehicular Technology (IEEE TVT)** 🔥

**Authors:** Fenglei Ren, Ziyang Gao, Yan Zhang, Haibo Zhou, Lu Yang, Zhichang Qin, Muyu Li
